/*==============================================================================
  ...
  Input:  b.<dx>_cco_merged  (case-crossover days with temperature `tem`,
          district `RVSN_ADDR_CD`, calendar `date`)
...
%macro make_hw_cw(dxlist);
  ...
  %do i = 1 %to &n;
    ...
    /* Split warm (Jun-Aug) and cold (Nov-Feb) seasons */
    ...
    data b.&thisdx._summer_flags;
      if _n_=1 then set &thisdx._quant_summer;
      set work.&thisdx._summer;
      by RVSN_ADDR_CD;
      heat95  = (tem >= P_95);
      heat975 = (tem >= P_97_5);
      heat99  = (tem >= P_99);
    ...
    data b.&thisdx._winter_flags;
      if _n_=1 then set &thisdx._quant_winter;
      set work.&thisdx._winter;
      by RVSN_ADDR_CD;
      cold1   = (tem <= P_1);
      cold2p5 = (tem <= P_2_5);
      cold5   = (tem <= P_5);
